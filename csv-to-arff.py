...
fileToRead = "training_data.csv"  #csv file name or absolute path to be open.
fileToWrite = "training_data.arff" #name as how you'll save your arff file.
relation = "Dreams" #how you'll like to call your relation as.
